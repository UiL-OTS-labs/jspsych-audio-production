...
let microphone_instructions = {
    type : jsPsychHtmlKeyboardResponse,
    stimulus : `<p>In the following screen you will be asked to choose
      and grant permissions to your computer's microphone, which will be used to record
      your responses during the experiment.</p>
...
let initialize_microphone = {
    ...
    device_select_message: "<p>Please select your computer's microphone</p>",
    button_label: 'Use this device'
};
...
let mic_check = {
    type: TestRecording,
    stimulus: 'Please say something out loud',
    recording_duration: 5000,
    stimulus_duration: 5000,
    allow_playback: true,
    show_done_button: false,
    playback_instructions: '<p>Please listen to your recording. Can you hear yourself clearly?</p>',
    accept_button_label: 'I can hear myself clearly',
